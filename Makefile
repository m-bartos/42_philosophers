...
#    Updated: 2024/01/31 16:21:46 by mbartos          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#sources
SRC_PATH =	src/
SRC = 	philo.c init.c init_utils.c check_args.c checker_thread.c eating.c libft_funcs.c mutexes_utils.c philo_utils.c sleeping_thinking.c time.c
